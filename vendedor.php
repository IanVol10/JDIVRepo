...
if ($seccion === 'ventas') {
    ...
    if (isset($_POST['confirmar'])) {
        if (!empty($_SESSION['venta'])) {
            ...
            $conn->query("INSERT INTO pedido (fecha, total, id_usuario) VALUES ('$fecha', '$total', '$id_usuario')");
            ...
            echo "<script>alert(' Venta registrada correctamente'); window.location='vendedor.php?seccion=ventas';</script>";
            exit();
        }
    }
...
<head>
<meta charset="UTF-8">
<title>Panel Vendedor - MotoBox</title>
